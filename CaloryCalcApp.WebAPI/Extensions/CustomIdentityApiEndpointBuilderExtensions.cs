...
using CaloryCalcApp.WebAPI.Models.DTOs;
...
namespace CaloryCalcApp.WebAPI.Extensions;

/// <summary>
/// Provides extension methods for <see cref="IEndpointRouteBuilder"/> to add identity endpoints.
/// </summary>
public static class CustomIdentityApiEndpointBuilderExtensions
{
        ...
        where TUser : class, new()
    {
            ...
            ([FromBody] RegisterUserDTO registration, HttpContext context, [FromServices] IServiceProvider sp) =>
        {
            ...
            var user = new TUser();
            if(user is HealthyUser healthyUser)
            {
                healthyUser.DateOfBirth = new DateOnly();
                healthyUser.Height  = registration.Height;
                healthyUser.Weight = registration.Weight;
                healthyUser.Sex = registration.Sex.ToString();
            }
