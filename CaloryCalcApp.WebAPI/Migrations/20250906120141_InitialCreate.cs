...
namespace CaloryCalcApp.WebAPI.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MealTime = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETUTCDATE()")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_HealthyUserDishes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HealthyUserDishes_AspNetUsers_HealthyUserId",
                        column: x => x.HealthyUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_HealthyUserDishes_Dishes_DishId",
                        column: x => x.DishId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HealthyUserDishes_DishId",
                table: "HealthyUserDishes",
                column: "DishId");

            migrationBuilder.CreateIndex(
                name: "IX_HealthyUserDishes_HealthyUserId",
                table: "HealthyUserDishes",
